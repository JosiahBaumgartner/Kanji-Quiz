const verbs = [
  {"Kanji":"","Hiragana":"","English":"","Alternate":null},
...
document.querySelector("#book").textContent = books[randomNum].japanese;
document.querySelector("#romaji").textContent = books[randomNum].romaji;
